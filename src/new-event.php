                ...
                <div class="d-flex">
                    ...
                    <div class="form-group form-event-new-group ml-3">
                        <input type="number" pattern="[0-9]*" inputmode="numeric"
                            class="form-control form-control-sm event-new-input recurrence d-none" id="recurrence-day-new" max="31" placeholder="Day recurrence">
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group form-event-new-group ml-3">
                        <input type="number" pattern="[0-9]*" inputmode="numeric"
                            class="form-control form-control-sm event-new-input recurrence d-none" id="recurrence-week-new" max="5" placeholder="Week recurrence">
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group form-event-new-group ml-3">
                        <input type="number" pattern="[0-9]*" inputmode="numeric"
                            class="form-control form-control-sm event-new-input recurrence d-none" id="recurrence-month-new" max="12" placeholder="Month recurrence">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
            </div>
