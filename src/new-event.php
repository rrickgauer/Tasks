    ...
    <div class="container">
        ...
        <form class="form-event-new">
            ...
            <div class="form-group form-event-new-group">
                ...
                <input type="text" class="form-control form-control-sm event-new-input" id="name-new" maxlength="100"
                    autofocus>
            ...
            <div class="event-dates-new">
                <div class="form-row">
                    ...
                    <!-- starts at -->
                    <div class="form-group form-event-new-group  col-2">
            ...
            <div class="event-recurrence-new">
                <div class="d-flex">
                    ...
                    <div class="form-group form-event-new-group mr-3">
                        <input type="number" class="form-control form-control-sm event-new-input d-none"
                            id="seperation-new" min="1" value="1">
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group form-event-new-group ml-3">
                        <input type="number" pattern="[0-9]*" inputmode="numeric"
                            class="form-control form-control-sm event-new-input recurrence d-none"
                            id="recurrence-day-new" max="31" placeholder="Day recurrence">
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group form-event-new-group ml-3">
                        <input type="number" pattern="[0-9]*" inputmode="numeric"
                            class="form-control form-control-sm event-new-input recurrence d-none"
                            id="recurrence-week-new" max="5" placeholder="Week recurrence">
                        <div class="invalid-feedback"></div>
                    </div>
                    ...
                    <div class="form-group form-event-new-group ml-3">
                        <input type="number" pattern="[0-9]*" inputmode="numeric"
                            class="form-control form-control-sm event-new-input recurrence d-none"
                            id="recurrence-month-new" max="12" placeholder="Month recurrence">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group form-event-new-group">
                ...
                <input type="text" class="form-control form-control-sm event-new-input" id="address-1-new"
                    maxlength="70">
            </div>
            ...
            <div class="form-group form-event-new-group">
                ...
                <input type="text" class="form-control form-control-sm event-new-input" id="address-2-new"
                    maxlength="70">
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group form-event-new-group col-6">
                    ...
                    <input type="text" class="form-control form-control-sm event-new-input" id="city-new"
                        maxlength="40">
                </div>
